...
vim.keymap.set("n", ":<leader>t", ":DiagnosticToggle<CR>")
...
vim.keymap.set("n", ":<leader><leader>k", ":bn!<CR>", { silent = true })
vim.keymap.set("n", ":<leader><leader>j", ":bp!<CR>", { silent = true })
vim.keymap.set("n", ":<leader><leader>d", ":bd!<CR>", { silent = true })

vim.keymap.set("n", "<leader>o", "gf<ESC>", { silent = true })
vim.keymap.set("n", "<leader>r", ":VRun<CR>", { silent = true })
